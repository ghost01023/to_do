...
// const loadInEditor = (elem: React.MouseEvent<HTMLDivElement>) => {
//   console.log(elem);
// }
...
export const NoteCard = ({htmlContent, setShowEditor, setSyncNoteDiv}: NoteCardTypes) => {
  console.log(htmlContent);
    return(
    <div className={"note-card"} onClick={(elem) => {setShowEditor(elem); setSyncNoteDiv(elem.currentTarget)}}>
