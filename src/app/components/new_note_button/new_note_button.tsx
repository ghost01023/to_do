...
const NewNoteButton = ({setCreateNewNote, setShowEditor}: NewNoteButtonProps) => {
    return (
        <button
            ...
            className="new-note-btn z-50 fixed right-5 bottom-4 text-2xl px-5 py-2.5 text-center inline-flex border-2 border-solid border-red-400 bg-red-400 rounded-md items-center focus:outline-none active:bg-red-400 transition duration-150 ease-in-out hover:bg-red-200">
            <svg
